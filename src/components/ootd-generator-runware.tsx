...
export default function OotdGeneratorRunware() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      const response = await generateOotdRunware({
        gender,
        style:
          style == "All"
      ...
      generateOotdImageRunware({
        ...
        cameraAngle:
          CAMERA_ANGLES[Math.floor(Math.random() * CAMERA_ANGLES.length)],
      })
        .then((imageResponse) => {
        ...
        .catch((err) => {
          ...
          toast({
            ...
            description:
              "Could not generate the outfit image. Please try again later.",
          });
        })
        .finally(() => {
          setIsGeneratingImage(false);
  ...
  return (
    <Card className="w-full shadow-lg border-none">
      <CardHeader>
        ...
        <CardDescription>
          Get a random AI-powered outfit recommendation based on your style and
          the season. <i>Powered by Runware.ai</i>
        </CardDescription>
      </CardHeader>
            ...
            <Card className="bg-card/80">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <ImageIcon className="h-5 w-5" /> Outfit Visualization
                </CardTitle>
              </CardHeader>
              <CardContent>
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-3xl p-0">
                        <DialogTitle className="sr-only">
                          Outfit Visualization Zoom
                        </DialogTitle>
                        <DialogDescription className="sr-only">
                          A larger view of the generated outfit image.
                        </DialogDescription>
                        <Image
                          src={imageUrl}
                          alt="Generated outfit"
